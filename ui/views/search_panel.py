...
class SearchPanel(ctk.CTkFrame):
    ...
    def create_list_item(self, item):
        ...
        title_label = ctk.CTkLabel(item_frame, text=item['title'], font=self.fonts['body_bold'], text_color=self.colors['text_primary'], anchor="w", justify="left", wraplength=340)
        title_label.grid(row=0, column=1, padx=(0, 12), pady=(8, 2), sticky="nw")

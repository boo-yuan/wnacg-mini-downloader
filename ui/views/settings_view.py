...
class SettingsWindow(ctk.CTkToplevel):
    def __init__(self, parent):
        ...
        api_seg_frame = ctk.CTkFrame(self.scroll_frame, fg_color="transparent")
        api_seg_frame.pack(fill="x", padx=24, pady=(0, 8))
        ...
        # 2. 网络代理
        ctk.CTkLabel(self.scroll_frame, text="网络代理", font=self.parent.app_fonts['body_bold'], text_color=self.parent.app_colors['text_primary']).pack(pady=(8, 4), padx=24, anchor="w")
        self.proxy_mode_var = ctk.StringVar(value=config_manager.proxy_mode)
        
        proxy_seg_frame = ctk.CTkFrame(self.scroll_frame, fg_color="transparent")
        proxy_seg_frame.pack(fill="x", padx=24, pady=(0, 8))
        ...
        speed_frame = ctk.CTkFrame(self.scroll_frame, fg_color=self.parent.app_colors['frame'], corner_radius=8)
        speed_frame.pack(fill="x", padx=24, pady=(0, 16))
